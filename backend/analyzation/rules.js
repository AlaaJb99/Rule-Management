const rules = [
    ...
    },
    {
        ...
        keywords: ["latency", "slow", "delay"]
    },
    {
        rule_name: "Outages and Downtime",
        keywords: ["outage", "downtime", "unavailable"]
    },
    {
        rule_name: "Critical Errors",
        keywords: ["critical", "error", "fatal"]
    },
    {
    ...
    },
    {
        ...
        keywords: ["privacy_breach", "data_leak"]
    },
    {
        rule_name: "Network Connectivity",
        keywords: ["network_down", "connection_lost"]
    },
    {
        rule_name: "Hardware Failure",
        keywords: ["hardware_failure", "component_error"]
    }
];
